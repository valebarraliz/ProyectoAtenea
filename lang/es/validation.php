...
return [
    ...
    */
    ...
    | utilizando la convención "atributo.regla" para nombrar las líneas. Esto facilita
    ...
    */
    ...
    'attributes' => [
        ...
        'users' => 'usuarios',
        'file' => 'archivo',
        'fileContents' => 'contenido_del_archivo',
        'header' => 'encabezado',
        'nameIndex' => 'indice_nombre',
        'cedulaIndex' => 'indice_cedula',
        'name' => 'nombre',
        'citizenNumber' => 'cedula',
        'id' => 'id',
        'discarded' => 'descartados',
        'votes' => 'votos',
        'partyIds' => 'ids_de_partidos',
        'partyNames' => 'nombres_de_partidos',
        'voteCounts' => 'conteos_de_votos',
        'party_id' => 'id_del_partido',
